package com.daishu.gateway.filter.log;


import com.daishu.gateway.base.GateWayOrder;
import com.daishu.gateway.utils.GenerateIdUtils;
import com.daishu.gateway.utils.IpUtils;
...
public class RequestLogFilter implements GlobalFilter, Ordered {
    ...
    @Override
    @ApiParam("设置最高级别,过滤的时候最先执行")
    public int getOrder() {
        return GateWayOrder.LOG.getOrder();
    }
